...
import {PaymentChannel} from "@/shims";
import FeaturedCardApi from "@/api/featured-card.ts";
import PaymentChannelApi from "@/api/payment-channel.ts";
import {useMount, useUnmount} from "ahooks";
import {boolMap} from "@/utils/list-tool.ts";

const columns: ProColumns<PaymentChannel>[] = [
    {
        title: 'ID',
        key: 'id',
        dataIndex: 'id',
        ...
        <div>
            <ProTable<PaymentChannel>
                ...
                request={async (params = {}, sort, filters) => {
                    ...
                    const result = await PaymentChannelApi.getList({
...
export default PaymentChannelIndexPage;
