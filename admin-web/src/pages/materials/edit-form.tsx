...
const EditForm = () => {
  ...
  const loadInfo = useCallback(
    ...
    setAgents([{ name: data.advertiser.user.nickname, id: data.advertiser.user.id }]);
    setAdvertisers([{id:data.advertiser.id,name:data.advertiser.companyName,agentId:data.advertiser.user.id}]);
